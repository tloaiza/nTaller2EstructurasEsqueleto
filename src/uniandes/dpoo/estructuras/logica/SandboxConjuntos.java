...
public class SandboxConjuntos
{
    ...
    {
        return new ArrayList<>(arbolCadenas.descendingSet());   //el descending set nos ayuda a organizarlas de mayor a menor
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        for (String var : arbolCadenas) {
            if (var.toUpperCase().equals(cadena_limpia)) {
                encontrada = var;
                break;
            }
        }
    ...
    public void eliminarPrimera( )
    {
    	if (!arbolCadenas.isEmpty()) {
            arbolCadenas.pollFirst();    //el metodo pollfirst nos ayuda a eliminar la primera
        }
    }
